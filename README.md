...
If used in WordPlate version 8 or higher you should also require [vlucas/phpdotenv](https://github.com/vlucas/phpdotenv) (please note that this replaces WordPlate's `env()` function with the one supplied by [illuminate/support](https://github.com/illuminate/support)):
